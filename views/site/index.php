...
<div class="site-index">
    ...
    <div class="container-fluid" id="uslugi" style="background: linear-gradient(to right, #412cad, #db31cf);color: #5ff9fc"> <h1 style="text-align: center; font-size: 40px;font-family: 'PT Sans Caption', sans-serif;">НАШИ УСЛУГИ</h1></div>
    <br>
    <div class="container opacback">
        ...
        <div class="grid">
            <figure class="effect-julia">
                <img src="../images/test.jpg" alt="img21"/>
                <figcaption>
            ...
            <figure class="effect-julia">
                ...
                <figcaption>
                    ...
                    <div>
                        ...
                        <p>До 6 страниц</p><br>
                        <p>Сайт-визитка позволит вам заявить о себе<br> за относительно небольшую цену</p>
                    </div>
                </figcaption>
            </figure>
            <figure class="effect-julia">
                <img src="../images/corp.jpg" alt="img22"/>
                <figcaption>
            ...
            <figure class="effect-julia">
                <img src="../images/test2.jpg" alt="img22"/>
                <figcaption>
                    <h2>Интернет <span>магазин</span></h2>
                    <div>
                        <p>Стильный и современный дизайн</p><br>
                        <p>Умный поиск</p><br>
                        <p>Гибкая настройка цен</p><br>
                        <p>Удобная система скидок</p><br>
                        <p>Отзывы о товарах</p><br>
                    </div>
                </figcaption>
            </figure>
            <div class="text-center">
                ...
                <div class="col-md-12 board">
                    <div class="board-inner">
                      ...
                      <span class="round-tabs one">
                            ...
                            <li class="how"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab" title="Разработка">
                     <span class="round-tabs two">
                         <i class="icon icon-pencil"></i>
                     </span>
                                </a>
                            </li>
                            <li class="how"><a href="#prototyping" aria-controls="prototyping" role="tab" data-toggle="tab" title="Тестирование">
                     <span class="round-tabs three">
                          <i class="icon icon-layers"></i>
                     </span> </a>
                            </li>

                            <li class="how"><a href="#uidesign" aria-controls="uidesign" role="tab" data-toggle="tab" title="Передача сайта">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="profile">
                            ...
                            <p class="narrow text-center">
                                В ходе разработки каждый член команды занимается тем, чему был обучен тысячилетиями упорных тренировок в тибетском монастыре
                            </p>
...
<!--                </div>-->
    ...
    <br>
    <div class="container-fluid" id="portfolio" style="background: linear-gradient(to right, #412cad, #db31cf);color: #5ff9fc" > <h1 style="text-align: center; font-size: 40px;font-family: 'PT Sans Caption', sans-serif;">ПОРТФОЛИО</h1></div>
   <br>
    <div class="container opacback">
           ...
           <div class="col-md-4">
               <div class="grid">
                   <figure class="effect-sadie">
                       ...
                       <figcaption>
                           <h2>Atlant</h2>
                           <p>Сайт-визитка для компании,осуществляющей грузоперевозки. Сайт отображает основную информацию о компании, позволяет ознакомится с услугами, а так же позваляет клиенту связаться с компанией.</p>
           ...
           <div class="col-md-4">
               <div class="grid">
                   <figure class="effect-sadie">
                       ...
                       <figcaption>
                           <h2>PSGroup</h2>
                           <p>Сайт для компании "PSGroup",осуществляющей продажу и покупку паллетов. Сайт позволяет ознакомиться с деятельностья комании, заказать товар, а так же имеет интересную систему скидок</p>
               ...
               <div class="grid">
                   <figure class="effect-sadie">
                       ...
                       <figcaption>
                           ...
                           <p>Сайт разработаный для интернет-провайдера "StarLineTelecom". Позволяет подробно ознакомиться с широким спектром услуг, предоставляемых компанией, а так же заказать эти услуги.</p>
           ...
           <div class="col-md-4">
               <div class="grid">
                   <figure class="effect-sadie">
                       ...
                       <figcaption>
                           <h2>changeulife</h2>
                           <p>Landing-page, для ознакомления с программой, по изменению своей жизни.</p>
   ...
   <br>
    ...
    <Br>
    <div class="container-fluid" id="kontakty" style="background: linear-gradient(to right, #412cad, #db31cf);color: #5ff9fc"> <h1 style="text-align: center; font-size: 40px;font-family: 'PT Sans Caption', sans-serif;">КОНТАКТЫ</h1></div>
            ...
            <?php else: ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 opacback" style="margin-left: 20px;color: white">
                        ...
                        <?= $form->field($model, 'name')->textInput(['autofocus' => false,'options'=>['class'=>'test-input'],]) ?>

                        <?= $form->field($model, 'email',[
                            'options'=>['class'=>'test-input'],])  ?>
                    ...
                    <div class="col-lg-6 opacback contact-block">
                        <div class="text-center" style="color:white"><h1>Контактные данные</h1></div>
                        <section id="fancyTabWidget" class="tabs t-tabs" style="color: black; margin-bottom: 50px">
                            <ul class="nav nav-tabs fancyTabs" role="tablist">

                                <li class="tab fancyTab active">
                                    <div class="arrow-down"><div class="arrow-down-inner"></div></div>
                                    <a id="tab0" href="#tabBody0" role="tab" aria-controls="tabBody0" aria-selected="true" data-toggle="tab" tabindex="0"><span class="fas fa-phone"></span><span class="hidden-xs"> Телефоны</span></a>
                                    <div class="whiteBlock"></div>
                                </li>

                                <li class="tab fancyTab">
                                    <div class="arrow-down"><div class="arrow-down-inner"></div></div>
                                    <a id="tab1" href="#tabBody1" role="tab" aria-controls="tabBody1" aria-selected="true" data-toggle="tab" tabindex="0"><span class="fas fa-at"></span><span class="hidden-xs"> Эл. почта</span></a>
                                    <div class="whiteBlock"></div>
                                </li>

                                <li class="tab fancyTab">
                                    <div class="arrow-down"><div class="arrow-down-inner"></div></div>
                                    <a id="tab2" href="#tabBody2" role="tab" aria-controls="tabBody2" aria-selected="true" data-toggle="tab" tabindex="0"><span class="fas fa-file-alt"></span><span class="hidden-xs"> Счета</span></a>
                                    <div class="whiteBlock"></div>
                                </li>
                            </ul>
...
<!--                                                    <strong>Корпоративный отдел:</strong> (495)716-98-18 доб.108-->
                                ...
                                <div class="tab-pane  fade" id="tabBody2" role="tabpanel" aria-labelledby="tab2" aria-hidden="true" tabindex="0">
                                    <div class="row">
                                        <div class="col-md-12">
<!--                                            <h2>Название организации <br> ООО НПО «ЭДМА»</h2>-->
<!--                                            <p>-->
<!--                                                Юридический адрес 117042, Москва г, Скобелевская ул, д. 8,э1,пом.IV <br>-->
<!--                                                Фактический адрес 117042, Москва г, Скобелевская ул, д. 8,э1,пом.IV <br>-->
<!--                                                ИНН 7736036898 <br>-->
<!--                                                КПП 772701001 <br>-->
<!--                                                Название банка ПАО «Сбербанк России». <br>-->
<!--                                                БИК 044525225 <br>-->
<!--                                                Корр. счет 30101810400000000225 <br>-->
<!--                                                Расчетный счет 40702810138140100467 <br>-->
<!--                                            </p>-->
                                        </div>
                                    </div>
                                </div>
